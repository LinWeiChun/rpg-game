...
public abstract class Career {
	...
	public String toString() {
		...
		builder.append(getCareerName() + " [healthPoint=").append(healthPoint).append(", magicPoint=").append(magicPoint)
				.append(", attack=").append(attack).append(", magicAttack=").append(magicAttack).append(", defence=")
				.append(defence).append(", magicDefence=").append(magicDefence).append("]");
